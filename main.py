...
# Load all the images and set demention of the screen
WIN_WIDTH = 500
WIN_HIGHT = 800
...
class Bird:
    ...
    def __init__(self, x, y):
        self.x = x
        self.y = y
        self.tilt = 0  # How much the bird is tilted so we can draw it in the screen
        self.tick_count = 0
        self.vel = 0
        self.height = self.y
    ...
    def jump(self):
        ...
        self.height = self.y  # At what point bird jump
